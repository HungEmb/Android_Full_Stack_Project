...
/*** hvu-aosp ***/
import android.os.SystemHvuleds;
...
final class SystemServiceRegistry {
    ...
    static {
        ...
        /*** hvu-aosp ***/
        registerService(Context.HVULEDS_SERVICE, HvuledsManager.class,
                new CachedServiceFetcher<HvuledsManager>() {
            @Override
            public HvuledsManager createService(ContextImpl ctx) {
                return new SystemHvuleds(ctx);
            }});
        /***************/
